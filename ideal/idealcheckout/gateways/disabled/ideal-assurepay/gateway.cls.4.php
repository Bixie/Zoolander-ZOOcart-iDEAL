			...
			else
			{
				...
				if($this->getRecordByOrder())
				{
					...
					else
					{
						...
						$sHtml .= '
<form action="' . htmlspecialchars(idealcheckout_getRootUrl() . 'transaction.php?order_id=' . $sOrderId . '&order_code=' . $sOrderCode) . '" method="post" id="idealcheckout">
			...
			else
			{
				...
				if($this->getRecordByOrder())
				{
					...
					else
					{
						...
						list($sTransactionId, $sTransactionUrl) = $oAssurePay->doTransactionRequest($sIssuerId, $this->oRecord['order_id'], $this->oRecord['transaction_amount'], $this->oRecord['transaction_description'], $this->oRecord['transaction_code'], idealcheckout_getRootUrl() . 'return.php', idealcheckout_getRootUrl() . 'report.php');

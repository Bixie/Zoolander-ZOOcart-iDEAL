...
<html>
	...
	<body>
		...
		<p>Via deze plugin kunt u <a href="http://www.ideal-checkout.nl/creditcard">Credit Card</a> betalingen ontvangen binnen uw webshop.</p>

		<h2>Transacties Controleren</h2>
		<p>Controleer de status van alle openstaande Credit Card transacties bij uw Payment Service Provider.<br><br><input type="button" value="Controleer openstaande transacties." onclick="javascript: window.open(\'validate.php?gateway=creditcard\', \'popup\', \'directories=no,height=550,location=no,menubar=no,resizable=yes,scrollbars=yes,status=no,toolbar=no,width=750\');"></p>
